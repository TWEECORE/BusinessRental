/// <summary>
/// Report TWE Standard Rental - Quote (ID 50009).
/// </summary>
report 50009 "TWE Standard Rental - Quote"
{
    RDLCLayout = 'StandardRentalQuote.rdlc';
    //WordLayout = 'StandardRentalQuote.docx';
    ...
    dataset
    {
        dataitem(Header; "TWE Rental Header")
        {
            ...
            RequestFilterHeading = 'Rental Quote';
            ...
            column(DocumentTitle_Lbl; RentalQuoteLbl)
            {
            }
            ...
            begin
                ...
                if not IsReportInPreviewMode() and
                   (CurrReport.UseRequestPage() and ArchiveDocumentBoolean or
                    not CurrReport.UseRequestPage() and (RentalSetup."Archive Quotes" <> RentalSetup."Archive Quotes"::Never))
                then
                    case RentalSetup."Archive Quotes" of
                        RentalSetup."Archive Quotes"::Always:
                            RentalArchiveManagement.ArchRentalDocumentNoConfirm(Header);
                        RentalSetup."Archive Quotes"::Question:
                            RentalArchiveManagement.ArchiveRentalDocument(Header);
                    end;
    ...
    requestpage
    {
        ...
        begin
            ...
            ArchiveDocumentBoolean := RentalSetup."Archive Quotes" <> RentalSetup."Archive Quotes"::Never;
        end;
    ...
    var
        ...
        RentalQuoteLbl: Label 'Rental Quote:';
