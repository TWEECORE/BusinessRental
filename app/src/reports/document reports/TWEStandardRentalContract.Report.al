/// <summary>
/// Report TWE Standard Rental - Contract (ID 50008).
/// </summary>
report 50008 "TWE Standard Rental - Contract"
{
    RDLCLayout = 'StandardRentalContract.rdlc';
    //WordLayout = 'StandardRentalContract.docx';
    ...
    dataset
    {
        dataitem(Header; "TWE Rental Header")
        {
            ...
            column(CompanyRegistrationNumber_Lbl; RegistrationNumberLbl)
            {
            }
            ...
            column(VATRegistrationNo_Lbl; YourVATRegistrationNo_Lbl)
            {
            }
            ...
            column(DocumentTitle_Lbl; RentalContractLbl)
            {
            }
            ...
            dataitem(Line; "TWE Rental Line")
            {
                ...
                column(VATIdentifier_Line_Lbl; VATIdentifier_Lbl)
                {
                }
                ...
                column(Total_Days_to_Invoice; "Total Days to Invoice")
                {
                }
                ...
                begin
                    ...
                    RentalFormatDocument.SetRentalLine(Line, FormattedQuantity, FormattedUnitPrice, FormattedVATPct, FormattedLineAmount);
            ...
            begin
                ...
                Line.DeleteAll();
                RentalPost.GetRentalLines(Header, Line, 0);
                Line.CalcVATAmountLines(0, Header, Line, VATAmountLine);
                Line.UpdateVATOnLines(0, Header, Line, VATAmountLine);

                if not IsReportInPreviewMode() then
                    CODEUNIT.Run(CODEUNIT::"TWE Rental-Printed", Header);
                ...
                RentalFormatAddr.GetCompanyAddr("Responsibility Center", RespCenter, CompanyInfo, CompanyAddr);
                RentalFormatAddr.RentalHeaderBillTo(CustAddr, Header);
                ShowShippingAddr := RentalFormatAddr.RentalHeaderShipTo(ShipToAddr, CustAddr, Header);
                ...
                if not IsReportInPreviewMode() and (CurrReport.UseRequestPage and ArchiveDocumentBoolean or
                   not CurrReport.UseRequestPage and RentalSetup."Archive Contracts") then
                    RentalArchiveManagement.StoreRentalDocument(Header, LogInteractionBoolean);
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(ArchiveDocument; ArchiveDocumentBoolean)
                    {
                        ApplicationArea = Basic, Suite;
                        ...
                        trigger OnValidate()
                        begin
                            if not ArchiveDocumentBoolean then
                                LogInteractionBoolean := false;
                        end;
                    }
                }
            }
        ...
        begin
            ...
            ArchiveDocumentBoolean := RentalSetup."Archive Contracts";
        end;
    ...
    begin
        if LogInteractionBoolean and not IsReportInPreviewMode() then
    ...
    var
        ...
        ArchiveDocumentBoolean: Boolean;
        ...
        RentalContractLbl: Label 'Rental Contract:';
        YourEstimateLbl: Label 'Your Estimate';
        EstimateLbl: Label 'Estimate';
        ClerkLbl: Label 'Your Clerk:';
        ...
        IBANLbl: Label 'IBAN:';
        RegistrationNumberLbl: Label 'Registration No.:';
        ...
        VATIdentifier_Lbl: Label 'VAT Identifier';
        Total_Days_to_Invoice_Lbl: Label 'Total Days';
    ...
    begin
        LogInteractionBoolean := SegManagement.FindInteractTmplCode(1) <> '';
    end;

    local procedure DocumentCaption(): Text[250]
    begin
        exit(RentalContractLbl);
    end;
    ...
    begin
        ...
        RentalFormatDocument.SetTotalLabels(RentalHeader.GetCurrencySymbol(), TotalText, TotalInclVATText, TotalExclVATText);
        RentalFormatDocument.SetSalesPerson(SalespersonPurchaser, RentalHeader."Salesperson Code", SalesPersonText);
        RentalFormatDocument.SetPaymentTerms(PaymentTerms, RentalHeader."Payment Terms Code", RentalHeader."Language Code");
        RentalFormatDocument.SetPaymentMethod(PaymentMethod, RentalHeader."Payment Method Code", RentalHeader."Language Code");
