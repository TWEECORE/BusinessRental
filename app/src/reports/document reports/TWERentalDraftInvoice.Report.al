/// <summary>
/// Report TWE Rental - Draft Invoice (ID 50003).
/// </summary>
report 50003 "TWE Rental - Draft Invoice"
{
    RDLCLayout = 'RentalDraftInvoice.rdlc';
    //WordLayout = 'RentalDraftInvoice.docx';
    Caption = 'Rental Draft Invoice';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Header; "TWE Rental Header")
        {
            ...
            column(SelltoCustomerNo; "Rented-to Customer No.")
            {
            }
            column(SelltoCustomerNo_Lbl; FieldCaption("Rented-to Customer No."))
            {
            }
            ...
            begin
                ...
                OnAfterRentalPostGetRentalLines(Header, Line);
                ...
                DocumentTitleText := DraftInvoiceLbl;
                YourDocumentTitleText := StrSubstNo(YourDocLbl, DraftInvoiceLbl);
                ...
                if RentalSetup.Get() then
                    if RentalSetup."Posted Rental Invoice Nos." <> '' then
                        NextInvoiceNo := NoSeriesManagement.ClearStateAndGetNextNo(RentalSetup."Posted Rental Invoice Nos.");
                ...
                if SellToContact.Get("Rented-to Contact No.") then;
                if BillToContact.Get("Bill-to Contact No.") then;

                if not IsReportInPreviewMode() and ArchiveDocumentBoolean then
                    RentalArchiveManagement.StoreRentalDocument(Header, false);
    ...
    var
        ...
        DraftInvoiceLbl: Label 'Draft Invoice';
    ...
    local procedure OnAfterRentalPostGetRentalLines(var RentalHeader: Record "TWE Rental Header"; var RentalLine: Record "TWE Rental Line")
    begin
    end;
