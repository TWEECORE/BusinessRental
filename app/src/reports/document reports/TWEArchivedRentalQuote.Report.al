/// <summary>
/// Report TWE Archived Rental Quote (ID 50001).
/// </summary>
report 50001 "TWE Archived Rental Quote"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'ArchivedRentalQuote.rdlc';
    Caption = 'Archived Rental Quote';
    ...
    dataset
    {
        dataitem("TWE Rental Header Archive"; "TWE Rental Header Archive")
        {
            ...
            RequestFilterHeading = 'Archived Rental Quote';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    {
                        DataItemTableView = SORTING(Number);
                        column(RentalLineArchTmp__Line_Amount_; TempRentalLineArch."Line Amount")
                        {
                            AutoFormatExpression = "TWE Rental Header Archive"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(RentalLineArchTmp_Description; TempRentalLineArch.Description)
                        {
                        }
                        column(RoundLoopBody3Visibility; TempRentalLineArch.Type = TempRentalLineArch.Type::" ")
                        {
                        }
                        ...
                        column(RoundLoopBody4Visibility; TempRentalLineArch.Type <> TempRentalLineArch.Type::" ")
                        {
                        }
                        column(RentalLineType; Format("TWE Rental Line Archive".Type))
                        {
                        }
                        column(RentalLineArchTmp__Line_Amount__Control84; TempRentalLineArch."Line Amount")
                        {
                            AutoFormatExpression = "TWE Rental Header Archive"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(RentalLineArchTmp__Inv__Discount_Amount_; TempRentalLineArch."Inv. Discount Amount")
                        {
                            AutoFormatExpression = "TWE Rental Header Archive"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(RentalLineArchTmp__Line_Amount__Control61; TempRentalLineArch."Line Amount")
                        {
                            AutoFormatExpression = "TWE Rental Header Archive"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(RentalLineArchTmp__Line_Amount__RentalLineArchTmp__Inv__Discount_Amount_; TempRentalLineArch."Line Amount" - TempRentalLineArch."Inv. Discount Amount")
                        {
                            AutoFormatExpression = "TWE Rental Header Archive"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(RentalLineArchTmp__Line_Amount__RentalLineArchTmp__Inv__Discount_Amount__Control88; TempRentalLineArch."Line Amount" - TempRentalLineArch."Inv. Discount Amount")
                        {
                            AutoFormatExpression = "TWE Rental Header Archive"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(RentalLineArchTmp__Line_Amount__RentalLineArchTmp__Inv__Discount_Amount____VATAmount; TempRentalLineArch."Line Amount" - TempRentalLineArch."Inv. Discount Amount" + VATAmount)
                        {
                            AutoFormatExpression = "TWE Rental Header Archive"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        begin
                            if Number = 1 then
                                TempRentalLineArch.Find('-')
                            else
                                TempRentalLineArch.Next();
                            "TWE Rental Line Archive" := TempRentalLineArch;
                        ...
                        begin
                            TempRentalLineArch.DeleteAll();
                        end;

                        trigger OnPreDataItem()
                        begin
                            MoreLines := TempRentalLineArch.Find('+');
                            while MoreLines and (TempRentalLineArch.Description = '') and (TempRentalLineArch."Description 2" = '') and
                                  (TempRentalLineArch."No." = '') and (TempRentalLineArch.Quantity = 0) and
                                  (TempRentalLineArch.Amount = 0)
                            do
                                MoreLines := TempRentalLineArch.Next(-1) <> 0;
                            if not MoreLines then
                                CurrReport.Break();
                            TempRentalLineArch.SetRange("Line No.", 0, TempRentalLineArch."Line No.");
                            SetRange(Number, 1, TempRentalLineArch.Count);
                        end;
                    }
    ...
    var
        ...
        TempRentalLineArch: Record "TWE Rental Line Archive" temporary;
        ...
        Rental_Header_Archive___No__CaptionLbl: Label 'Quote No.';
        ...
        Text004Lbl: Label 'Rental - Quote Archived %1', Comment = '%1 = Document No.';
    ...
    begin
        ...
        if RentalLineArchive.FindSet() then
            repeat
                TempRentalLineArch := RentalLineArchive;
                TempRentalLineArch.Insert();
