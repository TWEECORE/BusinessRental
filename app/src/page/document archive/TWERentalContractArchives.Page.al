/// <summary>
/// Page TWE Rental Contract Archives (ID 50001).
/// </summary>
page 50001 "TWE Rental Contract Archives"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Rental Contract Archives';
    CardPageID = "TWE Rental Contract Archive";
    Editable = false;
    PageType = List;
    ...
    actions
    {
        ...
        area(processing)
        {
            action("Delete Archived Versions")
            {
                ...
                ToolTip = 'Find and delete archived rental contract versions when the original rental contract has been deleted.';
            }
        }
    }
