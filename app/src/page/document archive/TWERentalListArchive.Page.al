/// <summary>
/// Page TWE Rental List Archive (ID 50002).
/// </summary>
page 50002 "TWE Rental List Archive"
{
    Caption = 'Rental List Archive';
    Editable = false;
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Suite;
                    ToolTip = 'Specifies which salesperson is associated with the rental list.';
                }
