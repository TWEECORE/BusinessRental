/// <summary>
/// Page TWE Rental Contract Archive (ID 50000).
/// </summary>
page 50000 "TWE Rental Contract Archive"
{
        ...
        area(content)
        {
            group(General)
            {
                ...
                group("Rented-to")
                {
                    ...
                    field(SellToPhoneNo; RentedToContact."Phone No.")
                    {
                        ApplicationArea = Suite;
                        Caption = 'Phone No.';
                    ...
                    field(SellToMobilePhoneNo; RentedToContact."Mobile Phone No.")
                    {
                        ApplicationArea = Suite;
                    ...
                    field(SellToEmail; RentedToContact."E-Mail")
                    {
                        ApplicationArea = Suite;
                        Caption = 'Email';
                        Importance = Additional;
                ...
                {
                    ApplicationArea = Suite;
                    ToolTip = 'Specifies which salesperson is associated with the rental contract.';
                }
            ...
            part(RentalLinesArchive; "TWE Rent. Cont. Arch. Subform")
            {
                ApplicationArea = Suite;
    ...
    begin
        if RentedToContact.Get(Rec."Rented-to Contact No.") then;
