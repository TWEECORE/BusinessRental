/// <summary>
/// Page TWE Rental Dup. Price Lines (ID 70704658).
/// </summary>
page 50006 "TWE Rental Dup. Price Lines"
{
    InsertAllowed = false;
    DeleteAllowed = false;
    LinksAllowed = false;
    PageType = Worksheet;
    SourceTable = "TWE Rental Dup. Price Line";
    ...
    var
        CurrPriceListLine: Record "TWE Rental Price List Line";
    ...
    begin
        ...
        case RentalPriceListHeader."Rental Price Type" of
            RentalPriceListHeader."Rental Price Type"::Rental:
                Page.RunModal(Page::"Sales Price List", RentalPriceListHeader);
        end;
    end;
    ...
    procedure Set(RentalPriceType: Enum "TWE Rental Price Type"; AmountType: Enum "Price Amount Type"; var RentalDuplicatePriceLine: Record "TWE Rental Dup. Price Line")
    begin
        Rec.Copy(RentalDuplicatePriceLine, true);
        ...
        IsSalesPrice := RentalPriceType = "Price Type"::Sale;
    end;
    ...
    procedure GetLines(var DuplicatePriceLine: Record "TWE Rental Dup. Price Line")
    begin
