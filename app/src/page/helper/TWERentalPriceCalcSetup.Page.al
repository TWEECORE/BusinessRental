/// <summary>
/// Page TWE Rental Price Calc. Setup (ID 50010).
/// </summary>
page 50010 "TWE Rental Price Calc. Setup"
{
    Caption = 'Rental Price Calculation Implementations';
    PageType = List;
    SourceTable = "TWE Rental Price Calc. Setup";
    DeleteAllowed = false;
    InsertAllowed = false;
