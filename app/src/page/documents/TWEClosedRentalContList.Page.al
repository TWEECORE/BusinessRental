/// <summary>
/// Page TWE Rental Contract List (ID 70704615).
/// </summary>
page 50000 "TWE Closed Rental Cont. List"
{
    ApplicationArea = Basic, Suite, Assembly;
    Caption = 'Closed Rental Contracts';
    CardPageID = "TWE Closed Rental Contract";
    ...
    QueryCategory = 'Closed Rental Contract List';
    RefreshOnActivate = true;
    SourceTable = "TWE Rental Header";
    SourceTableView = WHERE("Document Type" = CONST(Contract), "Rental Contract closed" = CONST(true));
    UsageCategory = Lists;
