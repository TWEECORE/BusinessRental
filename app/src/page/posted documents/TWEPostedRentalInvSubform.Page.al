/// <summary>
/// Page Posted Rental Invoice Subform (ID 70704626).
/// </summary>
page 50004 "TWE Posted Rental Inv. Subform"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    Editable = false;
    LinksAllowed = false;
    PageType = ListPart;
    SourceTable = "TWE Rental Invoice Line";
    ...
    layout
    {
        area(content)
        {
            ...
            group(Control28)
            {
                ...
                {
                    ShowCaption = false;
                    field("Invoice Discount Amount"; TotalRentalInvoiceHeader."Invoice Discount Amount")
                    {
                        ApplicationArea = Basic, Suite;
                        AutoFormatExpression = TotalRentalInvoiceHeader."Currency Code";
                        AutoFormatType = 1;
                        CaptionClass = DocumentTotals.GetInvoiceDiscAmountWithVATCaption(TotalRentalInvoiceHeader."Prices Including VAT");
                ...
                {
                    ShowCaption = false;
                    field("Total Amount Excl. VAT"; TotalRentalInvoiceHeader.Amount)
                    {
                        ApplicationArea = Basic, Suite;
                        AutoFormatExpression = TotalRentalInvoiceHeader."Currency Code";
                        AutoFormatType = 1;
                        CaptionClass = DocumentTotals.GetTotalExclVATCaption(TotalRentalInvoiceHeader."Currency Code");
                    ...
                    field("Total VAT Amount"; VATAmount)
                    {
                        ...
                        AutoFormatExpression = TotalRentalInvoiceHeader."Currency Code";
                        AutoFormatType = 1;
                        CaptionClass = DocumentTotals.GetTotalVATCaption(TotalRentalInvoiceHeader."Currency Code");
                        Caption = 'Total VAT';
                        Editable = false;
                        ToolTip = 'Specifies the sum of VAT amounts on all lines in the document.';
                    }
                    field("Total Amount Incl. VAT"; TotalRentalInvoiceHeader."Amount Including VAT")
                    {
                        ApplicationArea = Basic, Suite;
                        AutoFormatExpression = TotalRentalInvoiceHeader."Currency Code";
                        AutoFormatType = 1;
                        CaptionClass = DocumentTotals.GetTotalInclVATCaption(TotalRentalInvoiceHeader."Currency Code");
        ...
        area(processing)
        {
            group("&Line")
            {
                ...
                action(ItemShipmentLines)
                {
                    ...
                    Image = ShipmentLines;
                    ToolTip = 'View posted rental shipments for the item.';
    ...
    begin
        DocumentTotals.CalculatePostedRentalInvoiceTotals(TotalRentalInvoiceHeader, VATAmount, Rec);
    end;
    ...
    var
        TotalRentalInvoiceHeader: Record "TWE Rental Invoice Header";
