/// <summary>
/// Page TWE Post. Rent. Cr. Memo Lines (ID 50012).
/// </summary>
page 50012 "TWE Post. Rent. Cr. Memo Lines"
{
    Caption = 'Posted Rental Credit Memo Lines';
    Editable = false;
    PageType = List;
        ...
        area(navigation)
        {
            group("&Line")
            {
                ...
                action("Show Document")
                {
                    ...
                    trigger OnAction()
                    begin
                        RentalCrMemoHeader.Get(Rec."Document No.");
