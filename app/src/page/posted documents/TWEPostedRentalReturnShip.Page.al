/// <summary>
/// Page TWE Posted Rental Return Ship. (ID 70704640).
/// </summary>
page 50005 "TWE Posted Rental Return Ship."
{
    ApplicationArea = Basic, Suite;
    Caption = 'Posted Rental Return Shipments';
    CardPageID = "TWE Post. Rental Return Ship.";
    Editable = false;
    PageType = List;
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            action("&Print")
            {
                ...
                trigger OnAction()
                var
                    RentalRtnShptHeader: Record "TWE Rental Return Ship. Header";
                begin
                    RentalRtnShptHeader := Rec;
                    OnBeforePrintRecords(Rec, RentalRtnShptHeader);
                    CurrPage.SetSelectionFilter(RentalRtnShptHeader);
                    RentalRtnShptHeader.PrintRecords(true);
                end;
            }
            action("&Navigate")
            {
