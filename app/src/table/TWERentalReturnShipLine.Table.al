/// <summary>
/// Table TWE Rental Return Ship. Line (ID 50029).
/// </summary>
table 50029 "TWE Rental Return Ship. Line"
{
    Caption = 'Rental Return Shipment Line';
    DrillDownPageID = "TWE Post. Ret.Rent.Ship. Lines";
    LookupPageID = "TWE Post. Ret.Rent.Ship. Lines";
    ...
    fields
    {
        ...
        field(50029; "Line Closed"; Boolean)
        {
            Caption = 'Line Closed';
            DataClassification = CustomerContent;
        }
        ...
        field(70704630; "Belongs to Rental Contract"; Code[20])
        {
    ...
    var
        ...
        RentalReturnShptHeader: Record "TWE Rental Return Ship. Header";
        DimMgt: Codeunit DimensionManagement;
        UOMMgt: Codeunit "Unit of Measure Management";
        Text000Lbl: Label 'Shipment No. %1:', Comment = '%1= Document No.';
    ...
    begin
        if "Document No." = RentalReturnShptHeader."No." then
            exit(RentalReturnShptHeader."Currency Code");
        if RentalReturnShptHeader.Get("Document No.") then
            exit(RentalReturnShptHeader."Currency Code");
        exit('');
    end;
    ...
    begin
        ...
        repeat
            ...
            ClearSalesLineValues(RentalLine, false);
    ...
    begin
        RentalCommentLine.ShowComments(RentalCommentLine."Document Type"::"Return Shipment".AsInteger(), "Document No.", "Line No.");
    end;
    ...
    /// InitFromRentalLine.
    /// </summary>
    /// <param name="RentalReturnShptHeader">Record "TWE Rental Return Ship Header".</param>
    /// <param name="RentalLine">Record "TWE Rental Line".</param>
    procedure InitFromRentalLine(RentalReturnShptHeader: Record "TWE Rental Return Ship. Header"; RentalLine: Record "TWE Rental Line")
    begin
        Init();
        TransferFields(RentalLine);
        if ("No." = '') and HasTypeToFillMandatoryFields() then
            Type := Type::" ";
        "Posting Date" := RentalReturnShptHeader."Posting Date";
        "Document No." := RentalReturnShptHeader."No.";
        ClearSalesLineValues(RentalLine, false);
        ...
        "Belongs to Rental Contract" := RentalLine."No.";

        OnAfterInitFromRentalLine(RentalReturnShptHeader, RentalLine, Rec);
    end;

    local procedure ClearSalesLineValues(var RentalLine: Record "TWE Rental Line"; onlyQuantity: Boolean)
    begin
        ...
        if not onlyQuantity then begin
            RentalLine.Amount := 0;
    ...
    local procedure OnAfterDescriptionRentalLineInsert(var RentalLine: Record "TWE Rental Line"; RentalReturnShipmentLine: Record "TWE Rental Return Ship. Line"; var NextLineNo: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromRentalLine(RentalReturnShptHeader: Record "TWE Rental Return Ship. Header"; RentalLine: Record "TWE Rental Line"; var RentalReturnShptLine: Record "TWE Rental Return Ship. Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterInsertInvLineFromShptLine(var RentalLine: Record "TWE Rental Line"; RentalOrderLine: Record "TWE Rental Line"; NextLineNo: Integer; RentalReturnShipmentLine: Record "TWE Rental Return Ship. Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertInvLineFromShptLine(var RentalReturnShptLine: Record "TWE Rental Return Ship. Line"; var RentalLine: Record "TWE Rental Line"; RentalOrderLine: Record "TWE Rental Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertInvLineFromShptLineBeforeInsertTextLine(var RentalReturnShptLine: Record "TWE Rental Return Ship. Line"; var RentalLine: Record "TWE Rental Line"; var NextLineNo: Integer; var Handled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeCodeInsertInvLineFromShptLine(var RentalReturnShipmentLine: Record "TWE Rental Return Ship. Line"; var RentalLine: Record "TWE Rental Line"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnInsertInvLineFromShptLineOnAfterAssignDescription(var TWERentalReturnShipmentLine: Record "TWE Rental Return Ship. Line"; var RentalOrderLine: Record "TWE Rental Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnInsertInvLineFromShptLineOnAfterUpdatePrepaymentsAmounts(var RentalLine: Record "TWE Rental Line"; var RentalOrderLine: Record "TWE Rental Line"; var TWERentalReturnShipmentLine: Record "TWE Rental Return Ship. Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnInsertInvLineFromShptLineOnBeforeValidateQuantity(TWERentalReturnShipmentLine: Record "TWE Rental Return Ship. Line"; var RentalLine: Record "TWE Rental Line"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnInsertInvLineFromShptLineOnBeforeInsertDescriptionLine(TWERentalReturnShipmentLine: Record "TWE Rental Return Ship. Line"; var RentalLine: Record "TWE Rental Line"; TempRentalLine: Record "TWE Rental Line" temporary; var RentalInvHeader: Record "TWE Rental Header"; var NextLineNo: integer)
    begin
    end;
}
